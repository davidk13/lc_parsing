...
#page = requests.get('http://www.sec.gov/Archives/edgar/data/1409970/000140997015000082/salessup_20150120-0.htm')
#uses get method to retreieve webpage and data for filing from February 9, 2015

page = requests.get('http://www.sec.gov/Archives/edgar/data/1409970/000140997015000140/salessup_20150203-0.htm')
...
csv_out = open('salesup_newer_manual2.csv', 'wb')
