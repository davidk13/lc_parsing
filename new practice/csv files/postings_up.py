...
for lines in ops: 
	...
	#(commented out) uses get method to retrieve webpage and data for first filing (October 14, 2008)
		...
		csv_out = open('posting_' + str(c) + '.csv', 'wb')
		...
		rows_headings = zip(loan.key_heading, loan.amount_heading, loan.interest_rate_heading, 
		...
		rows_values = zip(loan.key, loan.amount, loan.interest_rate, loan.service_charge, loan.initial_maturity, loan.final_maturity, 
